import {LiveOrder} from '../../types/types';
...
export const wsMessage = createAction<LiveOrder, 'LIVE_TABLE_WS_MESSAGE'>('LIVE_TABLE_WS_MESSAGE');
export const wsError = createAction<string, 'LIVE_TABLE_WS_ERROR'>('LIVE_TABLE_WS_ERROR');

export type TOrderActions = ReturnType<typeof connect>
